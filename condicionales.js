alert("Bienvenido a la págona de JavaScript, completa el cuestionario");
var nom=prompt("Ingrese su nombre y apellido");
var res1 =prompt("¿Cómo se le llama al primer dia de la primavera?\nA: Primer día de la primavera\nB:Equinoccio de primavera \nC: Equinoccio de Invierno");
if(res1=="B"){
    res1=25;
}else{
    res1=0;
